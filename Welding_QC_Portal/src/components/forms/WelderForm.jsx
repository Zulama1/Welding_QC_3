...
export default function WelderForm({ onSubmit, onCancel }) {
  ...
  return (
    <div className="bg-white p-6 border border-slate-200 rounded-xl shadow-sm space-y-6">
      ...
      <div className="flex items-center justify-between border-b border-slate-100 pb-4">
        <div>
          <h3 className="text-base font-bold text-slate-900">Add Welder Profile</h3>
          <p className="text-xs text-slate-500">Register human capital records to the master database.</p>
        </div>
        <button 
          type="button"
          onClick={onCancel} 
